...
const translations = {
  en: {
    ...
    logout: 'Logout',
    // Hero
    heroChip: 'Myanmar Travel Planner',
heroH1Line1: 'Plan Your Trip',
heroH1Line2: 'in Myanmar — Free, Simple, Local.',
heroSub: 'Verified hotels & bus fares in MMK. No guesswork.',
startPlanningFree: 'Start Planning Free',
planMyTrip: 'Plan My Trip',
trustNoAccount: 'No account needed',
trustMMK: 'All prices in MMK',
trustFree: '100% Free to use',
ourCredentials:   'Our Credentials',
trustedAndVerified: 'Trusted & Verified.',
verified:         'Verified',
dptoaFullName:    'Domestic Pilgrimage & Tour Operator Association, Myanmar',
dptoaMember: 'Member of DPTOA',
builtForMyanmar: 'Built for Myanmar travelers',
builtForMyanmarDesc: 'Real local prices for locals & foreigners alike',
  ...
  mm: {
    ...
    logout: 'ထွက်ရန်',
    heroChip: 'မြန်မာ ခရီးသွား စီမံကိန်းရေးဆွဲသူ',
heroH1Line1: 'ခရီးစဉ်စီစဉ်ပါ',
heroH1Line2: 'မြန်မာနိုင်ငံတွင် — လွယ်ကူ၊ အခမဲ့',
heroSub: 'Hotel နှင့် ဘတ်ကားခ ကျပ်ငွေဖြင့် သိနိုင်သည်',
planMyTrip: 'ခရီးစဉ် စီစဉ်ရန်',
trustNoAccount: 'အကောင့်မလိုပါ',
trustMMK: 'ဈေးနှုန်းအားလုံး ကျပ်ဖြင့်',
trustFree: '၁၀၀% အခမဲ့',
ourCredentials:   'ကျွန်ုပ်တို့၏ အထောက်အထားများ',
trustedAndVerified: 'ယုံကြည်စိတ်ချရသော လုပ်ငန်း',
verified:         'အတည်ပြုပြီး',
dptoaFullName:    'ပြည်တွင်း ဘာသာရေးခရီးနှင့် ခရီးသွားလုပ်ငန်းရှင်များ အသင်း၊ မြန်မာနိုင်ငံ',
dptoaMember: 'DPTOA အဖွဲ့ဝင်',
builtForMyanmar: 'မြန်မာ ခရီးသွားများအတွက် ဖန်တီးထားသည်',
builtForMyanmarDesc: 'ပြည်တွင်းသားနှင့် နိုင်ငံခြားသား နှစ်ဦးစလုံးအတွက်',
