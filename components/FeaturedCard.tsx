...
export default function FeaturedCard({ destination }: Props) {
  ...
  return (
    <div className="bg-surface border border-border rounded-lg overflow-hidden shadow-md mt-[14px]">
      ...
      <div className="p-[18px]">
        ...
        <div className="flex gap-2">
          <Link
            href="/planner"
            className="flex-1 bg-green text-white text-[13px] font-semibold py-3 rounded-sm text-center transition-opacity active:opacity-80"
          >
