...
export default function Hero() {
  ...
  return (
    <section
      className="relative overflow-hidden min-h-[420px] flex items-end w-full"
      style={{
        background: [
          "linear-gradient(180deg,rgba(80,10,10,.65) 0%,rgba(90,10,10,.82) 60%,rgba(100,10,10,.95) 100%)",
    ...
    >
      <div className="relative z-10 w-full px-[18px] pt-8 pb-9">
        ...
        {/* Sub */}
        <p className="text-sm text-white/70 leading-[1.6] font-light mb-6 max-w-[340px]">
          {t('heroSub')}
        </p>
