...
/**
 * EmptyState — shown when a Supabase query returns 0 results.
 * Used in destinations, search results, dashboard, etc.
 */
export default function EmptyState({
  title = 'No trips found',
  description = 'We couldn\'t find any destinations matching your request. Check back soon — more are being added!',
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
      ...
      <h3 className="text-[18px] font-semibold text-ink tracking-[-0.3px] mb-2">
        {title}
      </h3>
      <p className="text-[13px] text-ink2 leading-[1.6] font-light max-w-[260px] mb-6">
        {description}
      </p>
