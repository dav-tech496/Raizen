  ...
  return (
    <>
      ...
      <main className="max-w-[480px] mx-auto pb-[90px]">
        ...
        <section className="px-[18px] pt-7 pb-7">
        ...
        {/* Why Raizen */}
        <section className="px-[18px] pt-1 pb-7">
        ...
        {/* CTA Banner */}
        <div className="mx-[18px] bg-green rounded-lg px-[22px] py-7 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <Link href="/planner" className="inline-block bg-white text-green text-sm font-semibold px-7 py-[14px] rounded-md shadow-[0_4px_14px_rgba(0,0,0,.15)] transition-transform active:scale-[0.97]">
              {t('startPlanningFree')}
            </Link>
          </div>
        </div>
