...
export default function Navbar({ onMenuOpen }: NavbarProps) {
  return (
    <header className="sticky top-0 z-[200] h-[58px] flex items-center justify-between px-[18px] bg-bg/93 backdrop-blur-[14px] border-b border-border no-print w-full">
      {/* Logo */}
      ...
      <button
        ...
        className="w-11 h-11 rounded-[10px] bg-surface2 border border-border flex flex-col items-center justify-center gap-[5px] transition-colors active:bg-border"
      >
